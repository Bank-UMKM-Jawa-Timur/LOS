<form action="{{ route('cabang.update', $cabang->kode_cabang) }}" method="POST">
  ...
  <div class="row">
    <div class="form-group col-md-6">
        ...
        <input type="text" name="kode_cabang" class="form-control @error('kode_cabang') is-invalid @enderror" placeholder="Kode Cabang" value="{{old('kode_cabang', $cabang->kode_cabang)}}">
        @error('kode_cabang')
