                                    ...
                                    <div class="d-flex">
                                        ...
                                        <ul class="dropdown-tb-menu hidden">
                                          @if (Auth::user()->role == 'Pincab')
                                            <li class="item-tb-dropdown">
                                              <a href="{{ route('pengajuan.check.pincab.status.detail', $item->id_pengajuan) }}">Review</a>
                                            </li>
                                            @if ($item->id_pbp != null)
                                                <li class="item-tb-dropdown open-modal" data-modal-id="modal-kembalikan-{{ $item->id }}" data-backto="PBP" >
                                                  <a href="#" id="btnKembalikan">Kembalikan ke PBP</a>
                                                </li>
                                            @elseif ($item->id_pbp == null && $item->id_pbo != null)
                                                <li class="item-tb-dropdown open-modal" data-modal-id="modal-kembalikan-{{ $item->id }}" data-backto="PBO" >
                                                  <a href="#" id="btnKembalikan">Kembalikan ke PBO</a>
                                                </li>
                                            @else
                                                <li class="item-tb-dropdown open-modal" data-modal-id="modal-kembalikan-{{ $item->id }}" data-backto="Penyelia" >
                                                  <a href="#" id="btnKembalikan">Kembalikan ke Penyelia</a>
                                                </li>
                                            @endif
                                            <li class="item-tb-dropdown open-modal" data-toggle="modal" data-modal-id="modal-kembalikan-{{ $item->id }}" data-backto="Penyelia" >
                                              <a href="#" data-target="#exampleModal-{{ $item->id_pengajuan }}">Disetujui / Ditolak</a>
                                            </li>
                                          @endif
                                            <li class="item-tb-dropdown">
                                        ...
                                        @elseif ($item->posisi == 'Selesai')
                                            ...
                                            <ul class="dropdown-tb-menu hidden">
                                                    ...
                                                    @if (Auth::user()->role == 'SPI' || Auth::user()->role == 'Kredit Umum' || auth()->user()->role == 'Direksi')
                                                            <li class="item-tb-dropdown">
                                                                <a href="{{ route('pengajuan.check.pincab.status.detail', $item->id_pengajuan) }}" class="dropdown-item">Review Pengajuan</a>
                                                            </li>
                                                        @if ($countAlasan > 0)
                                                            <li class="item-tb-dropdown">
                                                                <a data-toggle="modal" data-target="#modalRiwayatPengembalian-{{ $item->id }}" class="dropdown-item">Riwayat Pengembalian</a>
                                                            </li>
                                                        @endif
                                                    @endif
                                                    ...
                                                    @if (Auth::user()->role == 'Administrator')
                                                        <li class="item-tb-dropdown">
                                                            <a class="dropdown-item" data-toggle="modal" data-target="#modalLogPengajuan-{{ $item->id }}">Log Pengajuan</a>
                                                        </li>
                                                        <li class="item-tb-dropdown">
                                                            <a href="javascript:void(0)" class="dropdown-item"  data-toggle="modal" data-target="#confirmHapusModal{{$item->id}}">Hapus</a>
                                                        </li>
                                                    @endif
                                            </ul>
                                        @else
