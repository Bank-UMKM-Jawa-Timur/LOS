...
<form action="{{ route('pengajuan-kredit.store') }}" method="post">
    ...
    <div class="form-wizard {{ Session::get('id')  != null ? '' : 'active'}}" data-index='0' data-done='true'>
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <select name="kab" class="form-control select2" id="">
            ...
            <div class="form-group col-md-4">
                ...
                <select name="kec" class="form-control select2" id="">
    ...
    <div class="form-wizard {{ Session::get('id')  != null ? 'active' : ''}}" data-index='1' data-done="false">
