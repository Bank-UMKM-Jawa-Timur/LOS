                ...
                <div class="row form-group">
                    ...
                    @foreach ($dataLevelDua as $item)
                        @if ($item->opsi_jawaban == 'input text')
                            ...
                            @foreach ($dataDetailJawabanText as $itemTextDua)
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control mb-3" placeholder="Masukkan komentar"
                                        name="opsi_text[]" value="{{ $itemTextDua->opsi_text }}">
                                </div>
                        ...
                        @php
                            ...
                            // check level 3
                            $dataLevelTiga = \App\Models\ItemModel::select('id', 'nama', 'level', 'opsi_jawaban', 'id_parent')
                                ->where('level', 3)
                            ...
                            @if ($itemTiga->opsi_jawaban == 'input text')
                                ...
                                @foreach ($dataDetailJawabanText as $itemTextTiga)
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control mb-3" placeholder="Masukkan komentar"
                                            name="opsi_text[]" value="{{ $itemTextTiga->opsi_text }}">
                                    </div>
                                ...
                                @if ($itemEmpat->opsi_jawaban == 'input text')
                                    ...
                                    @foreach ($dataDetailJawabanTextEmpat as $itemTextEmpat)
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control mb-3" placeholder="Masukkan komentar"
                                                name="opsi_text[]" value="{{ $itemTextEmpat->opsi_text }}">
                                        </div>
