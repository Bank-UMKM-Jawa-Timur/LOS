                ...
                <div class="form-group-2 mb-4">
                    ...
                    <div class="input-box">
                        ...
                        <select name="pss" class="form-select" id="pss">
                            ...
                            <option value="Proses Input Data"
                                {{ Request()->query('pss') == 'Proses Input Data' ? 'selected' : '' }}>Proses Input Data
                            </option>
                            <option value="Review Penyelia"
                                {{ Request()->query('pss') == 'Review Penyelia' ? 'selected' : '' }}>Review Penyelia
                            </option>
                    ...
                    <div class="input-box">
                        ...
                        <select name="sts" class="form-select" id="sts">
                            ...
                            <option value="Selesai" {{ Request()->query('sts') == 'Selesai' ? 'selected' : '' }}>
                                Disetujui</option>
                            <option value="Proses Input Data"
                                {{ Request()->query('sts') == 'Proses Input Data' ? 'selected' : '' }}>
                                On Progress</option>
                            <option value="Ditolak" {{ Request()->query('sts') == 'Ditolak' ? 'selected' : '' }}>
                                Ditolak</option>
                        </select>
                    </div>
                </div>
