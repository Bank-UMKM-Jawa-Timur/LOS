<div class="modal-layout hidden" id="modal-update-data-cabang">
    <div class="modal modal-sm bg-white">
        ...
        <form action="{{ route('master-dana.update-cabang') }}" method="POST">
        @csrf
                ...
                <div class="form-group-1 mb-4">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" name="dana_idle"
                            class="form-input @error('dana_idle') is-invalid @enderror" placeholder="Dana Modal"
                            value="{{ old('dana_idle') }}">
                        @error('dana_idle')
                            <div class="invalid-feedback">
                                {{ $message }}
