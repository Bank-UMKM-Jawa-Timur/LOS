...
<div class="self-start bg-white w-full border">
            ...
            <dl class="max-w-full text-gray-900 divide-y bg-theme-primary/5 dark:text-white dark:divide-gray-700 p-3">
                ...
                <div class="flex flex-col pb-3 mb-1">
                    <div class="flex gap-3 mt-3">
                        ...
                        <dt class="mb-1 text-gray-500 md:text-sm dark:text-gray-400">{{ Carbon\Carbon::parse($item->created_at)->format('d-m-Y H:i:s') }}</dt>
                    </div>
                    <div class="flex gap-3 mt-3">
    ...
    >
        ...
        <div class="row space-y-5">
            ...
            <div class="form-group-2 {{$dataUmum->status == 'menikah' ? '' : 'hidden'}}" id="marry">
            ...
            {{-- @else --}}
            <div class="form-group-1 mt-3 {{$dataUmum->status != 'menikah' ? '' : 'hidden'}}" id="not-marry">
