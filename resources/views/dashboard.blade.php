                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 pr-0 font-wight-bold">
                                <h1>{{ \App\models\PengajuanModel::when(Request()->tAwal && Request()->tAkhir, function ($query) {
                                    ...
                                    ->where('pengajuan.id_penyelia', auth()->user()->id)
                                    ->where('posisi', '!=','Review Penyelia')
                    ...
                    <div class="card-body py-4">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 pr-0 font-wight-bold">
                                ...
                                ->where('pengajuan.id_pbo', auth()->user()->id)
                                ->orWhere('pengajuan.id_pbp', auth()->user()->id)
                    ...
                    <div class="card-body py-4">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 pr-0 font-wight-bold">
                                ...
                                ->where('id_staf', auth()->user()->id)
                                ->where('id_cabang', auth()->user()->id_cabang)
                                ->where('posisi','!=', 'Proses Input Data')
                                // ->where('posisi', 'Review Penyelia')
                                ->count() }}
                                </h1>
                            </div>
