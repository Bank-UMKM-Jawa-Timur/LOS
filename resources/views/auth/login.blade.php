...
<body>
    <section style="background-image: url('{{ asset('img/background.jpg') }} ')"
                ...
                <form method="post" id="login" action="{{ route('login') }}">
                    ...
                    <div class="form-wrapping space-y-12">
                        <div class="flex justify-center">
                            <img src="{{ asset('img/logo.svg') }}" alt="logo bank umkm" class="" />
                        </div>
                        <div class="bg-white w-full p-8 rounded-[10px]">
                            <div class="head text-center">
                                <h2 class="font-semibold text-theme-secondary tracking-tighter text-xl">
                                    Login Pincetar
                                    @if (session('error'))
                                        <div class="alert alert-danger">
                                            ...
                                            <strong><span class="fa fa-exclamation-triangle"></span> Gagal
                                                login.</strong> {{ session('error') }}
                                        </div>
                                    @endif
                                    @if ($errors->any())
                                        <div class="alert alert-danger">
                                    ...
                                    <div class="mt-5 space-y-5 text-left">
                                        <div class="input-box space-y-4">
                                            ...
                                            <div
                                                class="form-auth-input  border-2 rounded-md bg-gray-50 focus-within:bg-gray-100 flex">
                                                <!-- icon -->
                                        ...
                                        <div class="input-box space-y-4">
                                            ...
                                            <div
                                                class="form-auth-input focus:ring-0 ring-offset-transparent  border-2 rounded-md bg-gray-50 focus-within:bg-gray-100 flex gap-2">
                                                <!-- icon -->
                                                <div class="text-center ml-0 mt-0 p-2 text-gray-400">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-8"
                                                        viewBox="0 0 24 24">
