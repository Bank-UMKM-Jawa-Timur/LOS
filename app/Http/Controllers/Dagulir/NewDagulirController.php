                    ...
                    if (array_key_exists('data', $pengajuan_dagulir)) {
                        ...
                        if (array_key_exists('status_code', $response)) {
                            if ($response['status_code'] == 200) {
                                ...
                                return array_key_exists('message', $response) ? 'API error. '.$response['message'] : 'failed';
                            }
                        }
                        return $response;
                    }
            ...
            if (auth()->user()->role == 'Pincab') {
                ...
                if ($pengajuan) {
                    if ($currentPosisi == 'Pincab') {
                        ...
                        return redirect()->back()->withError('Hanya dapat memproses data pengajuan dengan posisi Pincab');
                    }
                }
                else {
